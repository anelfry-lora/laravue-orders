            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input id="remember-me" name="remember-me" type="checkbox" v-model="user.remember"
                        class="focus:text-blue-700 w-4 h-4 text-blue-600 border-blue-500 rounded" />
                    <label for="remember-me" class="block ml-2 text-sm font-semibold text-gray-900 select-none">
                        Remember me
                    </label>
                </div>
            </div>
